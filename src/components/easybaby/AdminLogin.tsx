    ...
    <div className="adm-root">
      <div className="adm-login">
        <div className="adm-login__card">
          ...
          <img className="adm-login__logo" src="/assets/logo-easybaby.png" alt="EasyBaby" />
          <span className="adm-login__eyebrow">EasyBaby</span>
          <h1 className="adm-login__title">Panel administracyjny</h1>
          <p className="adm-login__sub">Zarządzanie listą specjalistów. Dostęp wyłącznie dla autoryzowanych kont Google.</p>
