...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    // Folds in the general "how the list/recommendations work" copy that
    // used to sit as always-visible text between this and the next
    // accordion — it belongs conceptually with "Polecany Specjalista" since
    // it's explaining the recommendation mechanic.
    answer: `To specjalista polecony przez rodziców, którzy korzystali z jego wsparcia i chcą podzielić się swoim dobrym doświadczeniem. Na liście mogą znaleźć się między innymi pediatrzy, ortopedzi, fizjoterapeuci, osteopaci, położne, neurologopedzi czy psychologowie.

Przy każdym specjaliście znajdziesz podstawowe informacje oraz dowiesz się, kto polecił tę osobę.
